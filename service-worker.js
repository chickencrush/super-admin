const CACHE_NAME='cci-v7-2-0-1-owner_private-20260924';
const STATIC_FILES=['./','./index.html','./manifest.webmanifest','./input-owner.html','./cc-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
